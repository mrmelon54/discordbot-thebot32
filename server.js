...
app.get("/update-meta/ktane-solver.json", (request, response) => {
  response.sendFile(__dirname+'/ktane-solver-meta.json');
})
app.get("/update-meta/ktane-ideas.json", (request, response) => {
  response.sendFile(__dirname+'/ktane-ideas-meta.json');
})
